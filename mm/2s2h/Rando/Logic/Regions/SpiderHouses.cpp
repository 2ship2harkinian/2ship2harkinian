...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_SWAMP_SPIDER_HOUSE_BIG_POT_ROOM_LOWER] = RandoRegion{ .name = "Lower Big Pot Room", .sceneId = SCENE_KINSTA1,
        .checks = {
            ...
            CHECK(RC_SWAMP_SPIDER_HOUSE_BIG_POT_ROOM_LOWER_DEKU_FLOWER, CAN_BE_DEKU && CAN_PLAY_SONG(SONATA)),
        },
        .connections = {
    ...
    Regions[RR_SWAMP_SPIDER_HOUSE_BIG_POT_ROOM_UPPER] = RandoRegion{ .name = "Upper Big Pot Room", .sceneId = SCENE_KINSTA1,
        .checks = {
            ...
            CHECK(RC_SWAMP_SPIDER_HOUSE_BIG_POT_ROOM_UPPER_DEKU_FLOWER, CAN_BE_DEKU),
        },
        .connections = {
    ...
    Regions[RR_SWAMP_SPIDER_HOUSE_CENTER_ROOM_UPPER] = RandoRegion{ .name = "Upper Center Room", .sceneId = SCENE_KINSTA1,
        .checks = {
            ...
            CHECK(RC_SWAMP_SPIDER_HOUSE_MAIN_ROOM_UPPER_RIGHT_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_SWAMP_SPIDER_HOUSE_MAIN_ROOM_UPPER_CENTER_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_SWAMP_SPIDER_HOUSE_MAIN_ROOM_UPPER_LEFT_DEKU_FLOWER, CAN_BE_DEKU),
        },
        .connections = {
            CONNECTION(RR_SWAMP_SPIDER_HOUSE_MONUMENT_ROOM, true),

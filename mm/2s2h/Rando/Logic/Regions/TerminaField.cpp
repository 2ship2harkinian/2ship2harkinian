...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_TERMINA_FIELD] = RandoRegion{ .sceneId = SCENE_00KEIKOKU,
        .checks = {
            ...
            CHECK(RC_TERMINA_FIELD_NEAR_HOLLOW_LOG_RAMP_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_TERMINA_FIELD_NEAR_CHEST_STUMP_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_TERMINA_FIELD_NEAR_SWAMP_PATH_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_TERMINA_FIELD_NEAR_OBSERVATORY_DEKU_FLOWER, CAN_BE_DEKU),

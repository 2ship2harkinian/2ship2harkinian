...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_DEKU_PALACE_INSIDE_UPPER_CELL_SIDE] = RandoRegion{ .name = "Inside, Upper", .sceneId = SCENE_22DEKUCITY,
        .checks = {
            ...
            CHECK(RC_DEKU_PALACE_UPPER_CELL_SIDE_MAD_SCRUB_DEKU_FLOWER_1, CanKillEnemy(ACTOR_EN_DEKUNUTS) && CAN_BE_DEKU),
            CHECK(RC_DEKU_PALACE_UPPER_CELL_SIDE_MOVING_PLATFORM_DEKU_FLOWER_1, CanKillEnemy(ACTOR_EN_DEKUNUTS) && CAN_BE_DEKU),
            CHECK(RC_DEKU_PALACE_UPPER_CELL_SIDE_MAD_SCRUB_DEKU_FLOWER_2, CanKillEnemy(ACTOR_EN_DEKUNUTS) && CAN_BE_DEKU),
            // Accounting for entrance rando here to make sure the region connection allows coming from the cell ledge region
            CHECK(RC_DEKU_PALACE_UPPER_CELL_SIDE_MOVING_PLATFORM_DEKU_FLOWER_2, CAN_BE_DEKU),
        },
        .connections = {
    ...
    Regions[RR_DEKU_PALACE_INSIDE_UPPER_MIDDLE] = RandoRegion { .name = "Inside, Upper", .sceneId = SCENE_22DEKUCITY,
        .checks = {
            ...
            CHECK(RC_DEKU_PALACE_UPPER_BEAN_SIDE_CENTRAL_CONNECTOR_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_DEKU_PALACE_UPPER_CELL_SIDE_CENTRAL_CONNECTOR_DEKU_FLOWER, CAN_BE_DEKU),
        },
        .connections = {
            CONNECTION(RR_DEKU_PALACE_INSIDE_UPPER_CELL_SIDE, CanKillEnemy(ACTOR_EN_DEKUNUTS) && CAN_BE_DEKU),
    ...
    Regions[RR_DEKU_PALACE_INSIDE_UPPER_BEAN_SIDE] = RandoRegion { .name = "Inside, Upper", .sceneId = SCENE_22DEKUCITY,
        .checks = {
            CHECK(RC_ENEMY_DROP_MAD_SCRUB, CanKillEnemy(ACTOR_EN_DEKUNUTS) && CAN_BE_DEKU),
            CHECK(RC_DEKU_PALACE_UPPER_BEAN_SIDE_ENTRANCE_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_DEKU_PALACE_UPPER_BEAN_SIDE_MOVING_PLATFORM_DEKU_FLOWER_1, CAN_BE_DEKU),
            CHECK(RC_DEKU_PALACE_UPPER_BEAN_SIDE_MAD_SCRUB_DEKU_FLOWER_1, CanKillEnemy(ACTOR_EN_DEKUNUTS) && CAN_BE_DEKU),
            CHECK(RC_DEKU_PALACE_UPPER_BEAN_SIDE_MOVING_PLATFORM_DEKU_FLOWER_2, CanKillEnemy(ACTOR_EN_DEKUNUTS) && CAN_BE_DEKU),
            CHECK(RC_DEKU_PALACE_UPPER_BEAN_SIDE_MAD_SCRUB_DEKU_FLOWER_2, CanKillEnemy(ACTOR_EN_DEKUNUTS) && CAN_BE_DEKU),
        },
        .connections = {
    ...
    Regions[RR_DEKU_PALACE_OUTSIDE] = RandoRegion{ .name = "Outside", .sceneId = SCENE_22DEKUCITY,
        .checks = {
            ...
            CHECK(RC_DEKU_PALACE_WOODFALL_EXIT_DEKU_FLOWER, CAN_BE_DEKU),
        },
        .exits = { //     TO                                         FROM
    ...
    Regions[RR_ROAD_TO_SOUTHERN_SWAMP] = RandoRegion{ .sceneId = SCENE_24KEMONOMITI,
        .checks = {
            ...
            CHECK(RC_ROAD_TO_SOUTHERN_SWAMP_PATH_TO_TERMINA_DEKU_FLOWER_1, CAN_BE_DEKU),
            CHECK(RC_ROAD_TO_SOUTHERN_SWAMP_PATH_TO_TERMINA_DEKU_FLOWER_2, CAN_BE_DEKU),
            CHECK(RC_ROAD_TO_SOUTHERN_SWAMP_PATH_TO_TERMINA_DEKU_FLOWER_3, CAN_BE_DEKU),
            CHECK(RC_ROAD_TO_SOUTHERN_SWAMP_PATH_TO_ARCHERY_DEKU_FLOWER_1, CAN_BE_DEKU),
            CHECK(RC_ROAD_TO_SOUTHERN_SWAMP_PATH_TO_ARCHERY_DEKU_FLOWER_2, CAN_BE_DEKU),
            CHECK(RC_ROAD_TO_SOUTHERN_SWAMP_PATH_TO_ARCHERY_DEKU_FLOWER_3, CAN_BE_DEKU),
            CHECK(RC_ROAD_TO_SOUTHERN_SWAMP_PATH_TO_SWAMP_DEKU_FLOWER_1, CAN_BE_DEKU),
            CHECK(RC_ROAD_TO_SOUTHERN_SWAMP_PATH_TO_SWAMP_DEKU_FLOWER_2, CAN_BE_DEKU),
        },
        .exits = { //     TO                                         FROM
    ...
    Regions[RR_SOUTHERN_SWAMP_NORTH] = RandoRegion{ .name = "North Tourist Section", .sceneId = SCENE_20SICHITAI,
        .checks = {
            ...
            CHECK(RC_ENEMY_DROP_MINI_BABA, CanKillEnemy(ACTOR_EN_KAREBABA)),
            CHECK(RC_SOUTHERN_SWAMP_SCRUB_DEKU_FLOWER, CAN_BE_DEKU && Flags_GetRandoInf(RANDO_INF_OBTAINED_DEED_LAND)),
        },
        .exits = { //     TO                                         FROM
    ...
    Regions[RR_SOUTHERN_SWAMP_SOUTH_UPPER] = RandoRegion{ .name = "Upper South Section", .sceneId = SCENE_20SICHITAI,
        .checks = {
            ...
            CHECK(RC_SOUTHERN_SWAMP_BIG_MUSHROOM_DEKU_FLOWER_1, CAN_BE_DEKU),
            CHECK(RC_SOUTHERN_SWAMP_BIG_MUSHROOM_DEKU_FLOWER_2, CAN_BE_DEKU),
            CHECK(RC_SOUTHERN_SWAMP_BIG_MUSHROOM_DEKU_FLOWER_3, CAN_BE_DEKU),
            CHECK(RC_SOUTHERN_SWAMP_BIG_MUSHROOM_DEKU_FLOWER_4, CAN_BE_DEKU),
            CHECK(RC_SOUTHERN_SWAMP_SOARING_STONE_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_SOUTHERN_SWAMP_WOODFALL_ENTRANCE_DEKU_FLOWER, CAN_BE_DEKU),
        },
        .exits = { //     TO                                         FROM
    ...
    Regions[RR_WOODFALL] = RandoRegion{ .sceneId = SCENE_21MITURINMAE,
        .checks = {
            ...
            CHECK(RC_WOODFALL_MAD_SCRUB_DEKU_FLOWER_1, CAN_BE_DEKU && CanKillEnemy(ACTOR_EN_DEKUNUTS)),
            CHECK(RC_WOODFALL_MAD_SCRUB_DEKU_FLOWER_2, CAN_BE_DEKU && CanKillEnemy(ACTOR_EN_DEKUNUTS)),
            CHECK(RC_WOODFALL_MAD_SCRUB_DEKU_FLOWER_3, CAN_BE_DEKU && CanKillEnemy(ACTOR_EN_DEKUNUTS)),
            CHECK(RC_WOODFALL_MAD_SCRUB_DEKU_FLOWER_4, CAN_BE_DEKU && CanKillEnemy(ACTOR_EN_DEKUNUTS)),
            CHECK(RC_WOODFALL_MAD_SCRUB_DEKU_FLOWER_5, CAN_BE_DEKU && CanKillEnemy(ACTOR_EN_DEKUNUTS)),
            CHECK(RC_WOODFALL_MAD_SCRUB_DEKU_FLOWER_6, CAN_BE_DEKU && CanKillEnemy(ACTOR_EN_DEKUNUTS)),
            CHECK(RC_WOODFALL_MAD_SCRUB_DEKU_FLOWER_7, CAN_BE_DEKU && CanKillEnemy(ACTOR_EN_DEKUNUTS)),
            CHECK(RC_WOODFALL_MAD_SCRUB_DEKU_FLOWER_8, CAN_BE_DEKU && CanKillEnemy(ACTOR_EN_DEKUNUTS)),
        },
        .exits = { //     TO                                         FROM
    ...
    Regions[RR_WOODFALL_OWL_STATUE_PLATFORM] = RandoRegion{ .name = "Owl Statue Platform", .sceneId = SCENE_21MITURINMAE,
        .checks = {
            ...
            CHECK(RC_WOODFALL_OWL_STATUE_PLATFORM_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_DEKU_FLOWER_AT_TEMPLE_ENTRANCE, CAN_BE_DEKU && CanAccessDungeon(DUNGEON_SCENE_INDEX_WOODFALL_TEMPLE)),
        },
        .exits = { //     TO                                         FROM
    ...
    Regions[RR_WOODS_OF_MYSTERY] = RandoRegion{ .sceneId = SCENE_26SARUNOMORI,
        .checks = {
            ...
            CHECK(RC_WOODS_OF_MYSTERY_DEKU_FLOWER_1, CAN_BE_DEKU && FIRST_DAY()),
            CHECK(RC_WOODS_OF_MYSTERY_DEKU_FLOWER_2, CAN_BE_DEKU && FIRST_DAY()),
            CHECK(RC_WOODS_OF_MYSTERY_DEKU_FLOWER_3, CAN_BE_DEKU),
            CHECK(RC_WOODS_OF_MYSTERY_DEKU_FLOWER_4, CAN_BE_DEKU && (FIRST_DAY() || SECOND_DAY())),
            CHECK(RC_WOODS_OF_MYSTERY_DEKU_FLOWER_5, CAN_BE_DEKU && (FIRST_DAY() || SECOND_DAY())),
            CHECK(RC_WOODS_OF_MYSTERY_DEKU_FLOWER_6, CAN_BE_DEKU && (SECOND_DAY() || FINAL_DAY())),
            CHECK(RC_WOODS_OF_MYSTERY_DEKU_FLOWER_7, CAN_BE_DEKU && (SECOND_DAY() || FINAL_DAY())),
        },
        .exits = { //     TO                                         FROM

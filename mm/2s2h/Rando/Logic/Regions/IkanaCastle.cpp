...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_IKANA_CASTLE_CEILING_ROOM] = RandoRegion{ .name = "Ceiling Room", .sceneId = SCENE_CASTLE,
        .checks = {
            ...
            CHECK(RC_ANCIENT_CASTLE_OF_IKANA_LEFT_FIRST_ROOM_DEKU_FLOWER_1, CAN_BE_DEKU),
            CHECK(RC_ANCIENT_CASTLE_OF_IKANA_LEFT_FIRST_ROOM_DEKU_FLOWER_2, CAN_BE_DEKU),
            CHECK(RC_ANCIENT_CASTLE_OF_IKANA_LEFT_FIRST_ROOM_DEKU_FLOWER_3, CAN_BE_DEKU),
            CHECK(RC_ANCIENT_CASTLE_OF_IKANA_LEFT_FIRST_ROOM_DEKU_FLOWER_4, CAN_BE_DEKU),
            CHECK(RC_ANCIENT_CASTLE_OF_IKANA_LEFT_FIRST_ROOM_DEKU_FLOWER_5, CAN_BE_DEKU),
        },
        .connections = {
    ...
    Regions[RR_IKANA_CASTLE_OUTER_ROOF] = RandoRegion{ .name = "Outer Roof", .sceneId = SCENE_CASTLE,
        .checks = {
            ...
            CHECK(RC_ANCIENT_CASTLE_OF_IKANA_ROOF_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_ANCIENT_CASTLE_OF_IKANA_PILLAR_OPPOSITE_SWITCH_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_ANCIENT_CASTLE_OF_IKANA_FLAMING_PILLAR_DEKU_FLOWER_1, CAN_USE_PROJECTILE && CAN_BE_DEKU),
            CHECK(RC_ANCIENT_CASTLE_OF_IKANA_FLAMING_PILLAR_DEKU_FLOWER_2, CAN_USE_PROJECTILE && CAN_BE_DEKU),
        },
        .connections = {
    ...
    Regions[RR_IKANA_CASTLE_SKULLTULA_ROOM] = RandoRegion{ .name = "Skulltula Room", .sceneId = SCENE_CASTLE,
        .checks = {
            ...
            CHECK(RC_ANCIENT_CASTLE_OF_IKANA_LEFT_SECOND_ROOM_DEKU_FLOWER_1, CAN_BE_DEKU),
            CHECK(RC_ANCIENT_CASTLE_OF_IKANA_LEFT_SECOND_ROOM_DEKU_FLOWER_2, CAN_BE_DEKU),
            CHECK(RC_ANCIENT_CASTLE_OF_IKANA_LEFT_SECOND_ROOM_DEKU_FLOWER_3, CAN_BE_DEKU && (HAS_ITEM(ITEM_LENS_OF_TRUTH) && HAS_MAGIC && (HAS_ITEM(ITEM_BOW) || HAS_ITEM(ITEM_BOMB)))),
        },
        .connections = {

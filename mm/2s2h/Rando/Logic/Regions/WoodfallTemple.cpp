...
static RegisterShipInitFunc initFunc([]() {
    Regions[RR_WOODFALL_TEMPLE_BOSS_KEY_ROOM] = RandoRegion{ .name = "Boss Key Room", .sceneId = SCENE_MITURIN,
        .checks = {
            ...
            CHECK(RC_WOODFALL_TEMPLE_BOSS_KEY_ROOM_DEKU_FLOWER_1, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_BOSS_KEY_ROOM_DEKU_FLOWER_2, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_BOSS_KEY_ROOM_DEKU_FLOWER_3, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_BOSS_KEY_ROOM_DEKU_FLOWER_4, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_BOSS_KEY_ROOM_DEKU_FLOWER_5, CAN_BE_DEKU),
        },
        .connections = {
    ...
    Regions[RR_WOODFALL_TEMPLE_BOSS_ROOM] = RandoRegion{ .sceneId = SCENE_MITURIN_BS,
        .checks = {
            ...
            CHECK(RC_WOODFALL_TEMPLE_BOSS_ROOM_DEKU_FLOWER, CAN_BE_DEKU),
        },
        .exits = { //     TO                                         FROM
    ...
    Regions[RR_WOODFALL_TEMPLE_BOW_ROOM] = RandoRegion{ .name = "Bow Room", .sceneId = SCENE_MITURIN,
        .checks = {
            ...
            CHECK(RC_WOODFALL_TEMPLE_BOW_ROOM_DEKU_FLOWER_1, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_BOW_ROOM_DEKU_FLOWER_2, CAN_BE_DEKU),
        },
        .connections = {
            CONNECTION(RR_WOODFALL_TEMPLE_WATER_ROOM_UPPER, true),
        },
    ...
    Regions[RR_WOODFALL_TEMPLE_COMPASS_ROOM] = RandoRegion{ .name = "Compass Room", .sceneId = SCENE_MITURIN,
        .checks = {
            ...
            CHECK(RC_WOODFALL_TEMPLE_COMPASS_ROOM_DEKU_FLOWER_1, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_COMPASS_ROOM_DEKU_FLOWER_2, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_COMPASS_ROOM_DEKU_FLOWER_3, CAN_BE_DEKU),
        },
        .connections = {
    ...
    Regions[RR_WOODFALL_TEMPLE_DARK_ROOM] = RandoRegion{ .name = "Dark Room", .sceneId = SCENE_MITURIN,
        ...
        .connections = {
            CONNECTION(RR_WOODFALL_TEMPLE_PIT_ROOM, CAN_LIGHT_TORCH_NEAR_ANOTHER),
    ...
    Regions[RR_WOODFALL_TEMPLE_ENTRANCE] = RandoRegion{ .name = "Entrance", .sceneId = SCENE_MITURIN,
        .checks = {
            ...
            CHECK(RC_ENEMY_DROP_BOE, CanKillEnemy(ACTOR_EN_MKK)),
            CHECK(RC_WOODFALL_TEMPLE_ENTRANCE_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_ENTRANCE_SMALL_PLATFORM_1_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_ENTRANCE_CHEST_PLATFORM_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_ENTRANCE_SMALL_PLATFORM_2_DEKU_FLOWER, CAN_BE_DEKU),
        },
        .exits = { //     TO                                         FROM
    ...
    Regions[RR_WOODFALL_TEMPLE_MAIN_ROOM_UPPER] = RandoRegion{ .name = "Main Room Upper", .sceneId = SCENE_MITURIN,
        .checks = {
            ...
            CHECK(RC_WOODFALL_TEMPLE_MAIN_ROOM_DEKU_FLOWER, CAN_BE_DEKU),
        },
        .connections = {
            CONNECTION(RR_WOODFALL_TEMPLE_WATER_ROOM_UPPER, true),
            ...
            CONNECTION(RR_WOODFALL_TEMPLE_PIT_ROOM, true),
        },
        .events = {
    ...
    Regions[RR_WOODFALL_TEMPLE_MAP_ROOM] = RandoRegion{ .name = "Map Room", .sceneId = SCENE_MITURIN,
        .checks = {
            ...
            CHECK(RC_WOODFALL_TEMPLE_MAP_ROOM_DEKU_FLOWER_1, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_MAP_ROOM_DEKU_FLOWER_2, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_MAP_ROOM_DEKU_FLOWER_3, CAN_BE_DEKU),
        },
        .connections = {
    ...
    Regions[RR_WOODFALL_TEMPLE_PIT_ROOM] = RandoRegion{ .name="Pit Room", .sceneId = SCENE_MITURIN,
        .checks={
            CHECK(RC_WOODFALL_TEMPLE_PIT_ROOM_NEAR_STAIRS_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_PIT_ROOM_MOVING_PLATFORM_DEKU_FLOWER_1, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_PIT_ROOM_MOVING_PLATFORM_DEKU_FLOWER_2, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_PIT_ROOM_BALCONY_DEKU_FLOWER, CAN_BE_DEKU),
        },
        .connections = {
    ...
    Regions[RR_WOODFALL_TEMPLE_PRE_BOSS_ROOM] = RandoRegion{ .name = "Pre Boss Room", .sceneId = SCENE_MITURIN,
        .checks = {
            ...
            CHECK(RC_ENEMY_DROP_DRAGONFLY, CanKillEnemy(ACTOR_EN_GRASSHOPPER)),
            CHECK(RC_WOODFALL_TEMPLE_PRE_BOSS_ENTRANCE_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_PRE_BOSS_LOWER_ALCOVE_DEKU_FLOWER_1, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_PRE_BOSS_LOWER_ALCOVE_DEKU_FLOWER_2, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_PRE_BOSS_MID_ALCOVE_DEKU_FLOWER_1, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_PRE_BOSS_MID_ALCOVE_DEKU_FLOWER_2, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_PRE_BOSS_UPPER_ALCOVE_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_PRE_BOSS_MID_ROOM_PLATFORM_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_PRE_BOSS_UNDER_OVERHANG_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_PRE_BOSS_ON_TOP_OF_OVERHANG_DEKU_FLOWER, CAN_BE_DEKU && HAS_ITEM(ITEM_BOW)),
            CHECK(RC_WOODFALL_TEMPLE_PRE_BOSS_FLAMING_PILLAR_DEKU_FLOWER, CAN_BE_DEKU && HAS_ITEM(ITEM_BOW)),
        },
        .exits = { //     TO                                         FROM
    ...
    Regions[RR_WOODFALL_TEMPLE_WATER_ROOM] = RandoRegion{ .name = "Water Room", .sceneId = SCENE_MITURIN,
        .checks = {
            ...
            CHECK(RC_WOODFALL_TEMPLE_WATER_ROOM_NEAR_BOW_ROOM_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_WATER_ROOM_MOVING_PLATFORM_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_WOODFALL_TEMPLE_WATER_ROOM_NEAR_BOSS_KEY_ROOM_DEKU_FLOWER, CAN_BE_DEKU),
        },
        .connections = {
            CONNECTION(RR_WOODFALL_TEMPLE_MAIN_ROOM, true),

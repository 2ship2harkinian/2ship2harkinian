...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_STONE_TOWER_TEMPLE_LAVA_WIND_ROOM] = RandoRegion{ .name = "Lava Wind Room", .sceneId = SCENE_INISIE_N,
        .checks = {
            ...
            CHECK(RC_STONE_TOWER_TEMPLE_WIND_ROOM_DEKU_FLOWER, CAN_BE_DEKU),
        },
        .connections = {
    ...
    Regions[RR_STONE_TOWER_TEMPLE_INVERTED_WIND_ROOM] = RandoRegion{ .name = "Wind Room", .sceneId = SCENE_INISIE_R,
        .checks = {
            ...
            CHECK(RC_ENEMY_DROP_HIPLOOP, CanKillEnemy(ACTOR_EN_PP)),
            CHECK(RC_STONE_TOWER_TEMPLE_INVERTED_WIND_ROOM_ENTRANCE_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_STONE_TOWER_TEMPLE_INVERTED_WIND_ROOM_MID_LEVEL_DEKU_FLOWER, CAN_BE_DEKU),
        },
        .connections = {
    ...
    Regions[RR_STONE_TOWER_TEMPLE_INVERTED_POE_ROOM] = RandoRegion{ .name = "Poe Room", .sceneId = SCENE_INISIE_R,
        .checks = {
            ...
            CHECK(RC_STONE_TOWER_TEMPLE_INVERTED_POE_WIZZROBE_SIDE_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_STONE_TOWER_TEMPLE_INVERTED_POE_MAZE_SIDE_DEKU_FLOWER, CAN_BE_DEKU),
        },
        .connections = {
    ...
    Regions[RR_STONE_TOWER_TEMPLE_INVERTED_UNDER_BRIDGE] = RandoRegion{ .name = "Under Bridge", .sceneId = SCENE_INISIE_R,
        .checks = {
            ...
            CHECK(RC_STONE_TOWER_TEMPLE_INVERTED_UNDER_BRIDGE_POE_SIDE_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_STONE_TOWER_TEMPLE_INVERTED_UNDER_BRIDGE_POTS_DEKU_FLOWER, CAN_BE_DEKU && (HAS_ITEM(ITEM_HOOKSHOT) || HAS_ITEM(ITEM_BOW) || CAN_BE_ZORA)),
            CHECK(RC_STONE_TOWER_TEMPLE_INVERTED_UNDER_BRIDGE_GOMESS_DEKU_FLOWER, CAN_BE_DEKU),

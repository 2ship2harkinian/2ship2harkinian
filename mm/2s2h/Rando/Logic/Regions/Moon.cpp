...
static RegisterShipInitFunc initFunc([]() {
    Regions[RR_MOON_DEKU_TRIAL] = RandoRegion{ .sceneId = SCENE_LAST_DEKU,
        .checks = {
            ...
            CHECK(RC_MOON_TRIAL_DEKU_ENTRANCE_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_MOON_TRIAL_DEKU_LEDGE_NEAR_ENTRANCE_DEKU_FLOWER_1, CAN_BE_DEKU),
            CHECK(RC_MOON_TRIAL_DEKU_LEDGE_NEAR_ENTRANCE_DEKU_FLOWER_2, CAN_BE_DEKU),
            CHECK(RC_MOON_TRIAL_DEKU_MID_ROOM_LEDGE_DEKU_FLOWER_1, CAN_BE_DEKU),
            CHECK(RC_MOON_TRIAL_DEKU_MID_ROOM_LEDGE_DEKU_FLOWER_2, CAN_BE_DEKU),
            CHECK(RC_MOON_TRIAL_DEKU_HEART_PIECE_LEDGE_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_MOON_TRIAL_DEKU_EXIT_ROOM_LEDGE_DEKU_FLOWER, CAN_BE_DEKU),
        },
        .exits = { //     TO                                         FROM
